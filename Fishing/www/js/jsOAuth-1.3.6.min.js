...
exports.OAuth = function (e) {
    ...
    function i(e) {
        var t = arguments, n = t.callee, r = t.length, i, s = this, u = o.urlDecode;
        if (this instanceof n) {
    ...
    n.prototype = {join: function (e) {
        ...
        return e
    }}, t.prototype = new n, r.prototype = {scheme: "", host: "", port: "", path: "", query: "", anchor: "", toString: function () {
        ...
        var t = arguments, n = t.length, r, i, s, u = this, a, f = o.urlDecode;
        if (n == 1) {
            if (typeof e == "object")for (r in e)e.hasOwnProperty(r) && (u[r] = f(e[r])); else if (typeof e == "string") {
                i = e.split("&");
                for (r = 0, s = i.length; r < s; r++)a = i[r].split("="), a[0] != "" && (u[a[0]] = f(a[1]))
            }
        } else for (r = 0; r < n; r += 2)u[t[r]] = f(t[r + 1])
    };
    var s = "1.0";
    return o.prototype = {realm: "", requestTokenUrl: "", authorizationUrl: "", accessTokenUrl: "", init: function (e) {
        var t = "", n = {enablePrivilege: e.enablePrivilege || !1, proxyUrl: e.proxyUrl, callbackUrl: e.callbackUrl || "oob", consumerKey: e.consumerKey, consumerSecret: e.consumerSecret, accessTokenKey: e.accessTokenKey || t, accessTokenSecret: e.accessTokenSecret || t, verifier: t, signatureMethod: e.signatureMethod || "HMAC-SHA1"};
        return this.realm = e.realm || t, this.requestTokenUrl = e.requestTokenUrl || t, this.authorizationUrl = e.authorizationUrl || t, this.accessTokenUrl = e.accessTokenUrl || t, this.getAccessToken = function () {
            ...
            var t, i, h, p, d, v, m, g, y, b, w, E, S = [], x, T = {}, N, C, k;
            t = e.method || "GET", i = r(e.url), h = e.data || {}, p = e.headers || {}, d = e.success || function () {
            }, v = e.failure || function () {
            }, C = function () {
                var e = !1;
                for (var t in h)if (h[t]instanceof File || typeof h[t].fileName != "undefined")e = !0;
                return e
                ...
                if (m.readyState === 4) {
                    ...
                    var a = {text: m.responseText, xml: u ? m.responseXML : "", requestHeaders: t, responseHeaders: n};
                    m.status >= 200 && m.status <= 226 || m.status == 304 || m.status === 0 ? d(a) : m.status >= 400 && m.status !== 0 && v(a)
                }
            }, y = {oauth_callback: n.callbackUrl, oauth_consumer_key: n.consumerKey, oauth_token: n.accessTokenKey, oauth_signature_method: n.signatureMethod, oauth_timestamp: f(), oauth_nonce: l(), oauth_verifier: n.verifier, oauth_version: s}, b = n.signatureMethod, N = i.query.toObject();
            for (g in N)T[g] = N[g];
            if ((!("Content-Type"in p) || p["Content-Type"] == "application/x-www-form-urlencoded") && !C)for (g in h)T[g] = h[g];
            k = i.scheme + "://" + i.host + i.path, w = a(t, k, y, T), E = o.signatureMethod[b](n.consumerSecret, n.accessTokenSecret, w), y.oauth_signature = E, this.realm && (y.realm = this.realm), n.proxyUrl && (i = r(n.proxyUrl + i.path));
        ...
        this.request({url: e, success: t, failure: n})
    }, post: function (e, t, n, r) {
        this.request({method: "POST", url: e, data: t, success: n, failure: r})
    }, getJSON: function (e, t, n) {
        this.get(e, function (e) {
            t(JSON.parse(e.text))
        }, n)
    }, postJSON: function (e, t, n, r) {
        this.request({method: "POST", url: e, data: JSON.stringify(t), success: function (e) {
            n(JSON.parse(e.text))
        }, failure: r, headers: {"Content-Type": "application/json"}})
    ...
    }}, o.signatureMethod = {"HMAC-SHA1": function (t, n, r) {
        var i, s, u = o.urlEncode;
